...
books2_bp = Blueprint("books2", __name__, url_prefix="/v2/books")
...
@books2_bp.route('/<int:book_id>', methods=['GET'])
...
@books2_bp.route('/<int:book_id>', methods=['PUT'])
...
@books2_bp.route('/<int:book_id>', methods=['DELETE'])
